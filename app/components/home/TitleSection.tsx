    ...
    <div className="relative h-[600px] bg-cover bg-center" style={{ backgroundImage: "url('/img/hero-bg.jpg')" }}>
      ...
      <div className="relative flex flex-col items-center justify-center h-full text-center text-white">
        ...
        <div className="flex flex-col gap-4 md:flex-row">
          <button className="px-9 py-3 bg-white text-black font-semibold rounded-3xl hover:bg-gray-200 transition">Contact</button>
          <button className="px-9 py-3 bg-transparent border border-white text-white font-semibold rounded-3xl hover:bg-white hover:text-black transition">Learn</button>
        </div>
      </div>
    </div>
  );
